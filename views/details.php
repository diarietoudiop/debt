                ...
                <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-2 rtl:space-x-reverse sm:mb-0">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <a href="" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Article</a>
                        </div>
                    </li>
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <table class="min-w-full bg-white">
                            ...
                            <?php foreach ($articles as $article): ?>
                                <tr>
                                    <td class="border px-4 py-2"><?= $article->getLibelle() ?> FCFA</td>
                                    <td class="border px-4 py-2"><?= $article->getPrixUnitaire() ?> FCFA</td>
                                    <td class="border px-4 py-2"><?= $article->getQuantite() ?></td>
                                    <td class="border px-4 py-2"><?= $article->getMontant() ?></td>
